...
```{r, echo=3:4, results='hide', messages=FALSE, warnings=FALSE, fig.show='hold'}
require(gapfraction)
data(las)
chm(las)
chm.pf(las)
...
```{r, echo=3:4, results='hide', messages=FALSE, warnings=FALSE, fig.show='animate'}
require(gapfraction)
data(las)
chm <- chm.pf(las, stacked=TRUE, silent=TRUE)
itc.mw.h(chm, ht2rad=function(x) 0.15746*x)
```
